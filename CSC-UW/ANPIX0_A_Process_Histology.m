...
image_folder = 'W:\Data\acute\recovery_sleep\ANPIX0-Template\SHARP-Track_histology';
...
% CSC-UW: Raw images with 1.25x objective should be 2048x2048 @ 96 dpi and
% have a resolution of 2.612 um/pixel. Images resized to 600x600 @96 dpi
% using Joanna's method should have a resolution of (2048/600) * 2.612 =
% 8.9156 um/pixel. 
microns_per_pixel = 2.612; 
